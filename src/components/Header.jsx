    ...
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-slate-50">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        <Link to={"/"} className="flex items-center gap-2">
          ...
          <p className="text-headingColor text-xl font-bold">FoodRescue</p>
        </Link>
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            <motion.img
              ...
              className="w-10 mi-w-[40px] h-10 min-h-[40px] drop-shadow-xl cursor-pointer
              rounded-full"
              alt="userprofile"
              onClick={login}
            />
            ...
            absolute top-12 right-0"
              >
                {user && user.email == "yuktalimbu8@gmail.com" && (
                  <Link to={"/createItem"}>
                    <p
      ...
      <div className="flex items-center justify-between md:hidden w-full h-full">
        ...
        <div className="relative">
          ...
          transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2"
              ...
              <p
                className="m-2 p-2 rounded-md shadow-md flex items-center justify-center bg-gray-200 gap-3 cursor-pointer hover:bg-gray-300 transition-all 
              duration-100 ease-in-out text-textColor text-base"
                onClick={logout}
              >
                Logout <MdLogout />
